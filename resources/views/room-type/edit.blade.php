    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            <div class="p-4 sm:p-8 bg-white shadow sm:rounded-lg">
                <form class="p-6 max-w-3xl mx-auto" action="{{ route('room-type.update', $roomType->id) }}" method="POST"
                    ...
                    <div class="py-5 flex flex-col gap-5">
                        ...
                        <div class="flex w-full flex-col gap-1 text-neutral-600 dark:text-neutral-300">
                            <label for="textArea" class="w-fit pl-0.5 text-sm text-black">Facilities</label>
