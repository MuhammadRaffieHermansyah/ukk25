<x-app-layout>
    ...
    <div class="py-12">
        <form class="p-6 max-w-3xl mx-auto" action="{{ route('facilities.room.update', $roomFacility->id) }}" method="POST">
            @csrf
            @method('PUT')
            ...
            <div class="mt-4 text-end">
                <button href="{{ redirect(route('facilities.room.index')) }}" class="px-4 py-2 bg-gray-500 text-white rounded">
                    Cancel
                </button>
