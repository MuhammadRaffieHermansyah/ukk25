<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('Edit Hotel Facility') }}
        </h2>
    </x-slot>
    <div class="py-12">
        <form class="p-6 max-w-3xl mx-auto" action="{{ route('facilities.hotel.update', $hotelFacility->id) }}"
            ...
            <div class="py-5 flex flex-col gap-5">
                <div class="flex w-full flex-col justify-stretch gap-1 text-neutral-600 dark:text-neutral-300">
                    ...
                    <input id="textInputDefault" type="text"
                        ...
                        value="{{ $hotelFacility->name }}" />
                </div>
                <img src="{{ asset('storage/' . $hotelFacility->image) }}" alt="{{ $hotelFacility->name }}" class="h-52 w-52">
                ...
                <div class="flex w-full flex-col gap-1 text-neutral-600 dark:text-neutral-300">
                    ...
                    <textarea id="textArea" name="description"
                        ...
                        rows="3" placeholder="Write description here...">{{ $hotelFacility->description }}</textarea>
                </div>
            </div>
            <hr>
